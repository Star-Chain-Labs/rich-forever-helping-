...
import product1 from "../assets/dashboard/slider/img1.jpg";
import product2 from "../assets/dashboard/slider/img2.jpg";
...
const reviews = [
  {
    ...
    review:
      "These headphones have amazing sound quality! The bass is deep, and the noise cancellation is excellent. Highly recommend!",
    rating: 4.9,
    reviewCount: 1250,
  ...
  },
  {
    ...
    review:
      "This smartwatch is fantastic! The battery lasts long, and the fitness tracking features are very accurate. Worth every penny!",
    rating: 4.8,
    reviewCount: 1890,
          ...
          <SwiperSlide key={index}>
            <div className="flex items-center gap-6">
              <div className="lg:w-2/3">
                <h2 className="text-xl font-semibold">What Our Buyers Say?</h2>
