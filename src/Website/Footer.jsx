...
const Footer = () => {
  return (
    <>
      <footer className="bg-gray-200 text-black pt-12 pb-8 sm:px-[4rem] px-[2rem]">
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm  leading-relaxed">
              Rich Helping Plan combines herbal wellness and
      ...
      <div className="bg-gray-900 text-gray-400 py-5 text-xs md:text-sm text-ellipsiss text-center px-4">
        <p>
